...
from utils.model import Model_DMT
...
params = {
        ...
        "logs_path" : 'logs/03',
        "pretrained_model_path" : 'logs/03/checkpoint/0007.ckpt',
...
if __name__ == "__main__":
    ...
    model = Model_DMT(input_shape = params['image_shape'], logs_path = params['logs_path'], batch_size = params['batch_size'], classes = params['classes'])
