        ...
        if (estimate_pose(instance) == "Forward"):
            try:
                ...
                if (check == 1):
                    ...
                    plt.imshow(img)
                    # plt.show()
                    img_path = "D:/# Raras/src/data/edited/coba4" + img_name
                    img.save(img_path)
                else:
                    print("No face Detectedd")
            except:
                img = Image.open(instance)
                img_path = "D:/# Raras/src/data/error/coba4" + img_name
                img.save(img_path)
        else:
            img = Image.open(instance)
            img_path = "D:/# Raras/src/data/error/coba2" + img_name
            img.save(img_path)
    else:
